      ...
      <div>
          <div>
              <div className="relative">
                  <div className="overlay h-[29rem] opacity-[.6] bg-gray-900 absolute w-full "></div>
                  <img
                      src={AboutImg}
              ...
              <div className="py-8 flex w-full  justify-around">
                  <div className="w-[80%] flex flex-col gap-8">
                      <h1 className="text-[#159394] text-3xl font-bold">
                          INTELLIGENCE DRIVEN HEALTHCARE
                      </h1>
                      <div className="flex flex-col gap-1">
                          <h2 className="text-md font-bold">
                              We strive to enable nations in achieving Universal
                              Healthcare Goals
                          </h2>
                          <p className="text-md">
                              Intellio is a healthcare solutions firm focused on
                              providing global support that facilitates the
                              governments and organizations in providing the
                              best quality health at the most affordable cost.
                              At Intellio, we bring together a global team that
                              harbors a passion for health access and
                              innovation. The experience and outreach of our
                              teams is the core success driver of our underlying
                              philosophy of providing the best services at the
                              most affordable costs. We have identified and
                              developed the relationships with our partners that
                              we leverage for our clients to serve their needs
              ...
              <div className="imgbg flex  w-full  py-10 justify-around">
                  <div className="w-[80%]">
                      <h1 className="text-[#159394] text-center text-4xl font-bold">
                          PILLARS OF OUR PHILOSOPHY
                      </h1>
                      <div className="py-10 flex gap-6 flex-wrap">
                          {AboutUsCards.map((props, index) => (
                              <Link key={index} to={props.to}>
                                  <div className="w-96 flex flex-col items-center rounded hover:shadow-lg hover:scale-105 duration-500 gap-3 border bg-white p-6  h-64">
                                      <span className="text-4xl text-yellow-500">
                                          {props.icon}
                                      </span>
                                      <span className="text-lg text-[#159394] font-bold">
                                          {props.title}
                                      </span>
